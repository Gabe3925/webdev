describe("JavaScript Functions", function() {
  ...
  it('will accept arguments and will return a value when one is explicitly returned', function() {
    function add(a, b) {
      return a + b;
    }
  ...
  describe("scope and closure", function() {
    ...
    it('assigns all undeclared variables into global scope.', function() {
      function alexi() {
        //var n; //defines 'n' but does not assign it a variable
        function question() {
          n = 20;
        }
        question();
    ...
    it("allows immeditately-invoked function expressions (IIFE) to create a private scope for our sweet codes", function() {
