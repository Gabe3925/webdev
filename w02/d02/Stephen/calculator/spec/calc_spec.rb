...
describe Calculator do
  ...
  describe "#sum" do
    ...
    it "computes the sum of an array of many numbers" do
      expect(Calculator.new.sum([3, 3, 4, 10])).to eq(20)
    end
  end
  ...
  describe "#gcd" do
    it "computes the GCD of 2 and 4" do
      expect(Calculator.new.gcd(2,4)).to eq(2)
    end

    it "computes the GCD of 9 and 15" do
      expect(Calculator.new.gcd(9,15)).to eq(3)
    end

    it "computes the GCD of 0 and 50" do
      expect(Calculator.new.gcd(35,50)).to eq(5)
    end
  end
end
